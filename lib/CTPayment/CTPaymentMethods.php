...
class CTPaymentMethods
{
    const paymentMethods =
        [
            ...
            [
                'name' => 'fatchip_computop_klarna_direct_bank_transfer',
                'shortname' => 'Klarna Sofort',
                'description' => 'Computop Klarna Sofort',
                'action' => 'FatchipCTKlarnaPayments',
                'template' => 'fatchip_computop_klarna_direct_bank_transfer.tpl',
                'additionalDescription' => '',
                'className' => 'KlarnaPayments',
                //'countries' => ['DE', 'NL', 'DK', 'FI', 'SE', 'NO'],
            ],
            [
                'name' => 'fatchip_computop_klarna_direct_debit',
                'shortname' => 'Klarna Lastschrift',
                'description' => 'Computop Klarna Lastschrift',
                'action' => 'FatchipCTKlarnaPayments',
                'template' => 'fatchip_computop_klarna_direct_debit.tpl',
                'additionalDescription' => '',
                'className' => 'KlarnaPayments',
                //'countries' => ['DE', 'NL', 'DK', 'FI', 'SE', 'NO'],
            ],
